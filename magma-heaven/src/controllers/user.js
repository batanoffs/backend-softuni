...
userRouter.post("/register", isGuest(),
    ...
    body("password").trim().isLength({ min: 4 }).withMessage("passowrd must be at least 4 char long"),
    body("repass").trim().custom((value, { req }) => value == req.body.password).withMessage("passowrds dont match"),
    async (req, res) => {
